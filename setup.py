...
import json
import time
from data.libraries.twentyfivezeroone import RandomStr
...
def main():
    ...
    main_file_path = f"{current_directory}/main.py"
    rpc_file_path = f"{current_directory}/data/libraries/Inters.py"
